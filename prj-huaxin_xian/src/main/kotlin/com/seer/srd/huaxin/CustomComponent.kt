...
import com.seer.srd.huaxin.Services.getStationIdByLocation
import com.seer.srd.huaxin.Services.mesHttpClient
...
object CustomComponent {
  ...
  val extraComponents: List<TaskComponentDef> = listOf(
    ...
    TaskComponentDef(
      ...
      if (from in listOf("CZ1", "CZ2", "CZ3", "CZ4", "CZ5", "CZ6", "CZ7")) {
      ...
      if (to in listOf("CZ1", "CZ2", "CZ3", "CZ4", "CZ5", "CZ6", "CZ7")) {

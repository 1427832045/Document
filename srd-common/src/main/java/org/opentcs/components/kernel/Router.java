...
public interface Router extends Lifecycle {
     ...
     * </p>
     */
    String PROPKEY_ROUTING_GROUP = "robot:routingGroup";
    /**
     ...
     * </p>
     */
    String PROPKEY_ROUTING_COST_FORWARD = "robot:routingCostForward";
    /**
     ...
     * </p>
     */
    String PROPKEY_ROUTING_COST_REVERSE = "robot:routingCostReverse";
     ...
     *
     * @param vehicle      The vehicle for which the route must be passable.
     * @param srcPointName The starting point reference of the route.
     * @param dstPointName The end point reference of the route.
     * @return The costs of the route, or <code>Long.MAX_VALUE</code>, if no such
     * route exists.
     */
    long getCostsByPointRef(@Nonnull Vehicle vehicle, @Nonnull String srcPointName, @Nonnull String dstPointName);
     ...
     * @param srcLocName  A reference to the source location
     * @param destLocName A reference to the destination location
     * @return The costs of the route, or
     * <code>Long.MAX_VALUE</code>, if no such route exists.
     */
    long getCosts(@Nonnull Vehicle vehicle, @Nonnull String srcLocName, @Nonnull String destLocName);

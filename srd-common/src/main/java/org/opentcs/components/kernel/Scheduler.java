...
public interface Scheduler extends Lifecycle {
     ...
     */
    String PROPKEY_BLOCK_ENTRY_DIRECTION = "robot:blockEntryDirection";
     ...
     */
    void claim(@Nonnull Client client, @Nonnull List<Set<String>> resourceSequence)
     ...
     */
    void allocate(@Nonnull Client client, @Nonnull Set<String> resources)
            throws IllegalArgumentException;
     ...
     */
    void allocateNow(@Nonnull Client client, @Nonnull Set<String> resources)
     ...
     */
    void free(@Nonnull Client client, @Nonnull Set<String> resources);
    ...
    void freeAllExcept(@Nonnull Client client, @Nonnull Set<String> exceptResources);

    boolean isAllocatedBy(@Nonnull String resource, @Nonnull Client client);
     ...
     */
    @Nonnull
    Map<String, Set<String>> getAllocations();

    @Nonnull
    Set<String> getAllocationsByName(String name);
    ...
    interface Client {
         ...
         */
        boolean allocationSuccessful(@Nonnull Set<String> resources);
         ...
         */
        void allocationFailed(@Nonnull Set<String> resources);
    }
    ...
    interface Module
         ...
         */
        void claim(@Nonnull Client client, @Nonnull List<Set<String>> claim);
        ...
        void setAllocationState(@Nonnull Client client,
                                @Nonnull Set<String> alloc,
                                @Nonnull List<Set<String>> remainingClaim);
         ...
         * given client.
         */
        boolean mayAllocate(@Nonnull Client client, @Nonnull Set<String> resources);
         ...
         */
        default void prepareAllocation(@Nonnull Client client, @Nonnull Set<String> resources) {
        }
         ...
         */
        default boolean hasPreparedAllocation(@Nonnull Client client, @Nonnull Set<String> resources) {
            return true;
        }
         ...
         */
        default void allocationReleased(@Nonnull Client client, @Nonnull Set<String> resources) {
        }
    }
}

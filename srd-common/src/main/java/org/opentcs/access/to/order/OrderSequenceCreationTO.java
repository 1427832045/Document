...
public class OrderSequenceCreationTO
   ...
   */
  public OrderSequenceCreationTO withCategory(@Nullable String category) {
    return new OrderSequenceCreationTO(getName(),
                                       getModifiableProperties(),
                                       category,
                                       intendedVehicleName,
  ...
  public OrderSequenceCreationTO withFailureFatal(@Nullable Boolean failureFatal) {
    return new OrderSequenceCreationTO(getName(),
                                       getModifiableProperties(),
                                       category,
                                       intendedVehicleName,

...
public class CompositeVehicleComparator
    ...
    @Inject
    public CompositeVehicleComparator(Map<String, Comparator<Vehicle>> availableComparators) {
        ...
        for (String priorityKey : Lists.reverse(RouteConfigKt.getRouteConfig().getDispatcher().getVehiclePriorities())) {

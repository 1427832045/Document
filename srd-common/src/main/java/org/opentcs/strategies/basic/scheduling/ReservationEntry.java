...
public class ReservationEntry {
     ...
     */
    public ReservationEntry(final String reqResource) {
    ...
    void allocate(Client client) {
        ...
        counter++;
        if (counter > 1) {
            LOG.info("#### ALLOCATE the entry is {}", this.toString());
        }
    }
    ...
    void free() {
        ...
        if (counter == 0) {
            ...
            LOG.info("#### FREE the entry is {}", this.toString());
        }
    }
    ...
    void freeToOneReference() {
        if (counter > 1) {
            counter = 1;
            LOG.info("#### FREE entry {} to 1 reference", this.toString());
        }
    }

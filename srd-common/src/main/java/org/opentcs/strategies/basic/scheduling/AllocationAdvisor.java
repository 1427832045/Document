...
public class AllocationAdvisor
    ...
    @Override
    public void claim(Scheduler.Client client, List<Set<String>> resources) {
    ...
    @Override
    public boolean mayAllocate(Scheduler.Client client, Set<String> resources) {
        boolean result = true;
        for (Scheduler.Module module : modules) {
    ...
    @Override
    public void prepareAllocation(Scheduler.Client client, Set<String> resources) {
        requireNonNull(client, "client");
        requireNonNull(resources, "resources");
    ...
    @Override
    public void allocationReleased(Client client, Set<String> resources) {
        requireNonNull(resources, "resources");
